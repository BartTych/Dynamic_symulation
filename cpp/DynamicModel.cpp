...
DynamicModel::DynamicModel(
    ...
    )
    {
        ...
        this->damping_coefficient = 2.0 * std::sqrt(C_stiffness/10000 + mass_per_dof) * damping_ratio;
...
PYBIND11_MODULE(DynamicModel, m) {
    py::class_<DynamicModel>(m, "DynamicModel")
        ...
        .def("run_simulation", &DynamicModel::run_simulation, py::arg("n_steps"), py::arg("dt"),py::arg("log_interval"))
